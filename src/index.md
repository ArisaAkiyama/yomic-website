...
features:
  - title: Cross-Platform
    details: Available natively on Windows, macOS, and Linux thanks to Avalonia UI.
    icon: |
  ...
  - title: Extensions
    details: Bring your own content. Read from various sources by installing extensions.
    icon: |
    ...
    link: /docs/guides/extensions
    linkText: Learn about extensions
  - title: Modern UI
    details: Enjoy a clean, beautiful interface inspired by Fluent Design with dark and light themes.
    icon: |
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M16 18a2 2 0 0 1 2 2a2 2 0 0 1 2 -2a2 2 0 0 1 -2 -2a2 2 0 0 1 -2 2zm0 -12a2 2 0 0 1 2 2a2 2 0 0 1 2 -2a2 2 0 0 1 -2 -2a2 2 0 0 1 -2 2zm-7 1l1.5 3l3 1.5l-3 1.5l-1.5 3l-1.5 -3l-3 -1.5l3 -1.5l1.5 -3z" /></svg>
---
